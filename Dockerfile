...
COPY ./packages/bitcore-lib-peercoin/package.json ./packages/bitcore-lib-peercoin/package.json
...
COPY ./packages/bitcore-p2p-peercoin/package.json ./packages/bitcore-p2p-peercoin/package.json
