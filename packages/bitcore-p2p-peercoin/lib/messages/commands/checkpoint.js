...
var bitcore = require('bitcore-lib-peercoin');
 ...
 * @constructor
 */
function CheckpointMessage(arg, options) {
  Message.call(this, options);
  this.command = 'checkpoint';
  if (!arg) {
    arg = {};
  }
...
inherits(CheckpointMessage, Message);

CheckpointMessage.prototype.setPayload = function(payload) {
...
CheckpointMessage.prototype.getPayload = function() {
...
module.exports = CheckpointMessage;
