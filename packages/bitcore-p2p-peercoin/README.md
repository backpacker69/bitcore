...
[![NPM Package](https://img.shields.io/npm/v/bitcore-p2p-peercoin.svg?style=flat-square)](https://www.npmjs.org/package/bitcore-p2p-peercoin)

**The peer-to-peer networking protocol for BCH.**

`bitcore-p2p-peercoin` adds Bitcoin Cash protocol support for Bitcore.
...
```sh
npm install bitcore-p2p-peercoin
```
