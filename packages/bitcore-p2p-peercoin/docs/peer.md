...
Represents a node from the p2p peercoin network. The Peer class supports connecting directly to other nodes or through a socks5 proxy like Tor.
...
```javascript
var p2p = require('bitcore-p2p-peercoin')
var Peer = p2p.Peer;
